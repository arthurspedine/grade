...
public class RestExceptionHandler {
    ...
    @ExceptionHandler(StudentCsvValidationException.class)
    public ResponseEntity<List<ExceptionData>> studentCsvValidationException(StudentCsvValidationException e) {
